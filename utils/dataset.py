...
class   Carvana(data.Dataset):
    def __init__(self, root: str, scale: float = 0.5, transforms: Augmentation = Augmentation()) -> None:
        ...
        self.images_dir = os.path.join(self.root, "carvana/train_images")
        self.labels_dir = os.path.join(self.root, "carvana/train_masks/masks")
    ...
    def __getitem__(self, idx):
        ...
        mask_path = os.path.join(self.labels_dir, f"{filename}.jpg")
