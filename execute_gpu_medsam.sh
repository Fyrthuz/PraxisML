...
#------------------------------------------------------
#SBATCH -J medsam            # Job name
#SBATCH -o medsam_%j.o       # Name of stdout output file(%j expands to jobId)
#SBATCH -e medsam_%j.e       # Name of stderr output file(%j expands to jobId)
